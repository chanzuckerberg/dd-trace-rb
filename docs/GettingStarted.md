...
| `filter_exception_msg` | Filters top level messages in exceptions such that they don't reach Datadog | `false` |
| `filter_exception_trace` | Filters stack traces in exceptions such that they don't reach Datadog | `false` |
